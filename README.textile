...
The first thing you need to set is the account name.  This is the same as the web address (subdomain) for your account.
...
Find projects
   ...
   Mite::Project.all          # find all active projects of the current account.
   Mite::Project.find(1209)   # find single project by ID
